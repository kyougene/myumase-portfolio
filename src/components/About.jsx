...
const About = () => {
  return (
    <div>
      <Navbar />
        <div className="pt-24 px-4 mb-12 flex flex-col items-center">
          {/* Profile Section */}
          <div className="flex flex-col items-center text-center p-6 rounded-lg">
            <img className="h-[300px] w-[300px] object-cover rounded-full mb-4" src="/hero/profile.JPG" alt="Profile" />
            <div className="mt-4">
              <h2 className="text-3xl font-bold mb-4 tracking-wide">MYUMASE</h2>
              <p className="text-gray-800 text-lg leading-relaxed tracking-wider">
                東京を拠点に活動<br />
                2019年から独学で活動を始める。<br />
              ...
              <p className="text-gray-800 text-lg leading-relaxed tracking-wider mt-8">
                Based in Tokyo, Japan, I began working as a self-taught artist in 2019. <br />
                Using plants and nature as my main motifs, I create works with precise lines and vivid colors. <br />
                I strive to create artwork that is filled with honest emotion and brightens the feelings of those who see it. <br />
                Currently, I am expanding my activities internationally, including New York. <br />
                I also work on wall paintings and package designs.
              </p>
            </div>
          </div>

          {/* Activity Section */}
          <div className="mt-12 grid grid-cols-1 gap-8 text-center">
            <div>
